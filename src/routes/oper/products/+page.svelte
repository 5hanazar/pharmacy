<script lang="ts">
	export let data;
	import { DataTable, OverflowMenu, OverflowMenuItem, Pagination, Toolbar, ToolbarContent, ToolbarSearch, Checkbox, Button, DataTableSkeleton, Tag } from "carbon-components-svelte";
	...
	const headers = [
		...
		{ key: "barcode", value: "Barcode", sort: _ab0 },
